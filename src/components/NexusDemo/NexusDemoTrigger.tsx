...
export default function NexusDemoTrigger({ onClick }: NexusDemoTriggerProps) {
  return (
    <button
      onClick={onClick}
      className="group relative inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-2 sm:py-3 bg-[#D4FF00] text-[#0A0A0A] font-bold uppercase tracking-wider text-[10px] sm:text-sm hover:bg-[#D4FF00]/90 transition-colors rounded-lg sm:rounded-none"
    >
